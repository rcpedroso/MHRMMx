...
Rcpp::List sumV_SM_s(const arma::mat lam2_s,
  ...
  arma::mat Vi = arma::inv( HHi/sig2(i,d) + Ip/lam2_s(0,d) );
  sumV.slice(0) += Vi;
  ...
  arma::mat Vj = arma::inv( HHj/sig2(j,d) + Ip/lam2_s(1,d) );
  sumV.slice(1) += Vj;
  ...
  for (int k = 0; k < nS; k++) {
    ...
    if (z_split(Sk) == zij(0)) {
      arma::mat Vk = arma::inv( HHk/sig2(Sk,d) + Ip/lam2_s(0,d) );
      sumV.slice(0) += Vk;
      sumVH.col(0) += Vk*Hk.t()*yk/sig2(Sk,d);
    } else {
      arma::mat Vk = arma::inv( HHk/sig2(Sk,d) + Ip/lam2_s(1,d) );
      sumV.slice(1) += Vk;
...
Rcpp::List sumV_SM_m(const arma::vec lam2_m,
  ...
  arma::mat Yi = Y[i];
  arma::vec yi = Yi.col(d) - beta0(i,d);
  arma::mat Vi = arma::inv( HHi/sig2(i,d) + Ip/lam2_m(d) );
  sumV += Vi;
  ...
  arma::mat Yj = Y[j];
  arma::vec yj = Yj.col(d) - beta0(j,d);
  arma::mat Vj = arma::inv( HHj/sig2(j,d) + Ip/lam2_m(d) );
  sumV += Vj;
  ...
  for (int k = 0; k < nS; k++) {
    ...
    arma::mat Yk = Y[Sk];
    arma::vec yk = Yk.col(d) - beta0(Sk,d);
    arma::mat Vk = arma::inv( HHk/sig2(Sk,d) + Ip/lam2_m(d) );
    sumV += Vk;
