...
/* log(FRc) */
double logFRc(int repulsive, int J, double phi, double nu, double r, int n, arma::mat df) {
  
  double sumJ = 0;
  
  // absolute values of the differences between the current or proposal
  // cluster-specific curve and the cluster-specific curves of the other J-1 components
